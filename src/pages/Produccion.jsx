...
import { produccionHistorica, produccionSemanal, velocidadPorHora } from '@/data/mockProduccion';
import { kpis, produccionPorHora } from '@/data/mockDashboard';
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <KPICard title="Desviación" value={kpis.desviacionAcumulada} unit="uds" sub={`${kpis.desviacionPct}% vs plan`} color={kpis.desviacionAcumulada >= 0 ? 'green' : 'red'} size="lg" />
